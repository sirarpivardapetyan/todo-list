                ...
                <Col xs={10} sm={8} md={6} lg={4} className="border mt-5 p-3 m-auto">
                    <div className="mb-3">
                        ...
                        <input ref={nameRef} type="text"
                            className={`${styles.textInput} ${nameErrorMessage ? styles.invalid : ""} form-control mb-3`}
                            id="name"
                            placeholder="name" />
                        <label htmlFor="email" className="form-label">Email address*</label>
                        <input ref={emailRef}
                            type="email"
                            className={`${styles.textInput} ${emailErrorMessage ? styles.invalid : ""} form-control`}
                            id="email"
                    ...
                    <div className="mb-3">
                        ...
                        <textarea ref={messageRef}
                            className={`${styles.textInput} ${messageErrorMessage ? styles.invalid : ""} form-control`}
